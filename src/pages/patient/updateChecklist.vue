      ...
      <wd-tabs v-model="tab" swipeable animated>
        ...
        <block>
          <wd-tab title="肝肾功">
            ...
            <InputChart title="AST" china="(天门冬氨酸氨基转移酶)" v-model="form.renalFunction.ALT" unit="U/L" low="0"
              height="40">
            </InputChart>

            <InputChart title="TBIL" china="(总胆红素)" v-model="form.renalFunction.TBIL" unit="mmol/L" low="5.1"
              height="19">
            </InputChart>
        ...
        <block>
          <wd-tab title="免疫">
            <InputChart title="ESP" china="(血沉12)" :isRequire="isRequire" v-model="form.immunity.ESR" unit="mm/1h"
              low="0" height="20">
            </InputChart>

            <InputChart title="CRP或hsCRP" china="" :isRequire="isRequire" v-model="form.immunity.CRP" unit="mg/L"
              low="0" height="10">
            </InputChart>
        ...
        <block>
          <wd-tab title="凝血">
            ...
            <InputChart title="APPT" china="活化部分活血凝酶时间" v-model="form.coagulation.APPT" unit="s" low="22.7"
              height="31.8">
            </InputChart>
