...
const List = reactive([
  ...
  { 'title': "访视信息", 'url': "/pages/patient/follow", 'src': "../../static/img/fangshi.png", 'bg': 'linear-gradient(148.45deg, rgba(254, 91, 199, 1) 0%, rgba(253, 85, 198, 1) 20%, rgba(253, 78, 197, 1) 40%, rgba(252, 71, 195, 1) 60%, rgba(252, 64, 194, 1) 80%, rgba(251, 55, 193, 1) 100%)' },
  ...
  { 'title': "治疗方案", 'url': "/pages/patient/updateTreat", 'src': "../../static/img/zhiliaofangan.png", 'bg': 'linear-gradient(153.97deg, rgba(254, 147, 0, 1) 0%, rgba(255, 136, 0, 1) 20%, rgba(255, 125, 0, 1) 40%, rgba(255, 114, 0, 1) 60%, rgba(255, 102, 0, 1) 80%, rgba(255, 88, 0, 1) 100%);' },
  { 'title': "辅助检查", 'url': "/pages/patient/updateAuxiliaryCheck", 'src': "../../static/img/fuzhujiancha.png", 'bg': 'linear-gradient(148.45deg, rgba(254, 91, 199, 1) 0%, rgba(253, 85, 198, 1) 20%, rgba(253, 78, 197, 1) 40%, rgba(252, 71, 195, 1) 60%, rgba(252, 64, 194, 1) 80%, rgba(251, 55, 193, 1) 100%);' },
