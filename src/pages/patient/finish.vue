...
const List = reactive([
  ...
  { 'title': "诊断确认",'src': "../../static/img/confirm.png", 'bg': 'linear-gradient(149.47deg, rgba(255, 211, 0, 1) 0%, rgba(255, 204, 0, 1) 19.43%, rgba(255, 198, 0, 1) 38.85%, rgba(255, 191, 0, 1) 58.28%, rgba(255, 185, 0, 1) 77.71%, rgba(255, 178, 0, 1) 97.13%)'},
  { 'title': "基本信息",'src': "../../static/img/baseinfo.png", 'bg': 'linear-gradient(151.24deg, rgba(0, 203, 255, 1) 0%, rgba(9, 194, 255, 1) 20%, rgba(13, 185, 255, 1) 40%, rgba(13, 176, 255, 1) 60%, rgba(9, 167, 255, 1) 80%, rgba(0, 158, 255, 1) 100%)'},
  { 'title': "病史",'src': "../../static/img/bingshi.png", 'bg': 'linear-gradient(149.47deg, rgba(255, 211, 0, 1) 0%, rgba(255, 204, 0, 1) 19.43%, rgba(255, 198, 0, 1) 38.85%, rgba(255, 191, 0, 1) 58.28%, rgba(255, 185, 0, 1) 77.71%, rgba(255, 178, 0, 1) 97.13%)'},
  { 'title': "合并症",'src': "../../static/img/hebingzheng.png", 'bg': 'linear-gradient(148.45deg, rgba(254, 91, 199, 1) 0%, rgba(253, 85, 198, 1) 20%, rgba(253, 78, 197, 1) 40%, rgba(252, 71, 195, 1) 60%, rgba(252, 64, 194, 1) 80%, rgba(251, 55, 193, 1) 100%)'},
  ...
  { 'title': "访视信息",'src': "../../static/img/fangshi.png", 'bg': 'linear-gradient(148.45deg, rgba(254, 91, 199, 1) 0%, rgba(253, 85, 198, 1) 20%, rgba(253, 78, 197, 1) 40%, rgba(252, 71, 195, 1) 60%, rgba(252, 64, 194, 1) 80%, rgba(251, 55, 193, 1) 100%)'},
